...
function imageview(temp, type) {
    ...
    if (n4) {
        url = 'shop/image_view17ba.html?scroll=' + imgsc + '&image=/shopimages/' + db + '/' + escape(temp);
    } else {
        url = 'shop/image_view17ba.html?scroll=' + imgsc + '&image=/shopimages/' + db + '/' + temp;
    }
...
function login_chk(brandcode) {
    ...
    location.href = 'shop/member564d.html?type=wish&amp;brandcode=' + brandcode;
}

function warehousing_call(branduid) {
    win = window.open('shop/soldout_sms_popbb62.html?branduid=' + branduid, 'soldout_sms', 'width=450,height=330');
    win.focus();
}
